...
module.exports = {
  ...
  head : {title : 'glowsquid-next', meta : [ {charset : 'utf-8'} ]},
  plugins : [
  ...
  tailwindcss : {
    config : {
      purge : [
        './components/**/*.{vue,js}', './layouts/**/*.vue', './pages/**/*.vue',
        './plugins/**/*.{js,ts}', './nuxt.config.{js,ts}'
      ],
      theme : {extend : {}},
      variants : {
        extend :
            {width : [ 'hover', 'focus' ], transitionProperty : [ 'important' ]}
      },
