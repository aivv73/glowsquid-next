module.exports = {
  ...
  addInstanceModal : {
    ...
    ramSettings : {
      title : 'Ram settings',
      minRam : {title : 'Min ram', hint : 'Minimum ram allocated to Minecraft'},
      maxRam : {title : 'Max ram', hint : 'Maximum ram allocated to Minecraft'}
    },
    randomSettings : {
      ...
      assetRoot : {
        title : 'asset Root',
        hint :
            'Where minecraft assets are stored. You shouldn\'t need to change this. Leave blank for default'
      }
    }
  },
  settings : {
  ...
  pages : {
    home : {
      text :
          'Welcome to Glowsquid, the fabric-first modrinth-powered Minecraft launcher'
    },
    about : {
    ...
    instances : {
      search : 'Search',
      status :
          'Current Status: Downloading {download} | Type: {type} | {percent}% Downloaded',
      launch : 'launch',
      moreInfo : 'More info',
      settings : 'Settings(Deletes instances rn)',
      mcVersion : 'Minecraft version: <span class="font-bold">{version}</span>',
      fabricVersion :
          'Fabric loader version: <span class="font-bold">{version}</span>'
    },
    instance : {
      status :
          'Current Status: Downloading {download} | Type: {type} | {percent}% Downloaded',
      addMods : 'Add mods',
      settings : 'Settings',
      tabs : {description : 'Description', mods : 'Mods'}
    },
    mods : {
      search : 'Search mods',
      about : 'About',
